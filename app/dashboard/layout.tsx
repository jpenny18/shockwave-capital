          ...
          <div className="border-t border-[#2F2F2F] pt-4 mt-4">
            <div className="flex items-center gap-3 px-3 py-2">
              <div className="w-8 h-8 rounded-full bg-[#0FF1CE]/20 flex items-center justify-center">
                <span className="text-[#0FF1CE] font-medium text-sm">JP</span>
              </div>
              <div className="flex-1 min-w-0">
                <div className="text-white text-sm font-medium truncate">John Piper</div>
                <div className="text-gray-400 text-xs truncate">john@example.com</div>
              </div>
